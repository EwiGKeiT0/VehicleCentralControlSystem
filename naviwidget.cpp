    ...
    , mainWindow(father)
{
    ...
    setGradient(ui->lineEdit,QColor(192, 192, 192),QColor(58,58,60),150,"font-size: 20px;");
    setGradient(ui->edit_search,QColor(192, 192, 192),QColor(58,58,60),150,"font-size: 20px;");
    setGradient(ui->pushButton,QColor(58,58,60),QColor(192, 192, 192),150);
    setGradient(ui->pushButton_2,QColor(58,58,60),QColor(192, 192, 192),150);
    setGradient(ui->enlargeBtn,QColor(58,58,60),QColor(192, 192, 192),150);
    setGradient(ui->reduceBtn,QColor(58,58,60),QColor(192, 192, 192),150);
