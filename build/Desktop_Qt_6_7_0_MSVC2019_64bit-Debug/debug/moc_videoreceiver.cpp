...
void VideoReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (VideoReceiver::*)(const QPixmap & );
            if (_t _q_method = &VideoReceiver::frameReceived; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void VideoReceiver::frameReceived(const QPixmap & _t1)
{
