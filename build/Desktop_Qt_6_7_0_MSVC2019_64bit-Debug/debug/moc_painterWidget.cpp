...
struct qt_meta_stringdata_CLASSPainterWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSPainterWidgetENDCLASS = QtMocHelpers::stringData(
    "PainterWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSPainterWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject PainterWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSPainterWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSPainterWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSPainterWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *PainterWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSPainterWidgetENDCLASS.stringdata0))
